...
class AuthSessionRestored implements AuthState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthSessionRestored);
}
...
@override
String toString() {
  return 'AuthState.sessionRestored()';
}
