...
String lostFoundTypeLabel(AppLocalizations l10n, String type) =>
    switch (type) {
...
extension AdminDealerItemL10n on AdminDealerItem {
  ...
  List<AdminDetailField> localizedDetails(AppLocalizations l10n) => [
        AdminDetailField(
          label: l10n.adminFieldBoothName,
          value: boothName,
        ),
        if (boothNumber?.isNotEmpty == true)
          AdminDetailField(
...
extension AdminUserItemL10n on AdminUserItem {
  ...
  List<AdminDetailField> localizedDetails(AppLocalizations l10n) => [
        ...
        AdminDetailField(
          label: l10n.adminFieldDisplayName,
          value: displayName,
        ),
        ...
        if (dateOfBirth?.isNotEmpty == true)
          AdminDetailField(
            label: l10n.adminFieldDateOfBirth,
            value: dateOfBirth!,
          ),
        AdminDetailField(
...
extension AdminConbookItemL10n on AdminConbookItem {
  List<AdminDetailField> localizedDetails(AppLocalizations l10n) => [
        ...
        if (imageUrl.isNotEmpty)
          AdminDetailField(
            label: l10n.adminFieldConbookImage,
            imageUrl: imageUrl,
          ),
        AdminDetailField(
          label: l10n.adminFieldSubmittedAt,
...
extension AdminTicketItemL10n on AdminTicketItem {
  ...
  List<AdminDetailField> localizedDetails(AppLocalizations l10n) => [
        ...
        if (conBadgeName?.isNotEmpty == true)
          AdminDetailField(
            label: l10n.adminFieldBadgeName,
            value: conBadgeName!,
          ),
        ...
        if (denialReason?.isNotEmpty == true)
          AdminDetailField(
            label: l10n.adminDenyReason,
            value: denialReason!,
          ),
        if (badgeImage?.isNotEmpty == true)
          AdminDetailField(
            label: l10n.adminFieldBadgeImage,
            imageUrl: badgeImage,
          ),
        if (namecardUrl?.isNotEmpty == true)
          AdminDetailField(
            label: l10n.adminFieldNamecard,
            imageUrl: namecardUrl,
          ),
        AdminDetailField(
          label: l10n.adminFieldCreatedAt,
          value: formatAdminDate(createdAt),
...
extension AdminLostFoundItemL10n on AdminLostFoundItem {
  ...
  List<AdminDetailField> localizedDetails(AppLocalizations l10n) => [
        ...
        if (staffNotes.isNotEmpty)
          AdminDetailField(
            label: l10n.adminFieldStaffNotes,
            value: staffNotes,
          ),
        if (returnedAt != null && recipientName.isNotEmpty) ...[
          AdminDetailField(
            label: l10n.adminFieldRecipient,
            value: recipientName,
          ),
          AdminDetailField(
