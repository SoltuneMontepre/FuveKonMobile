...
// UpdateTshirtSizeRequest sets the user's ticket merch T-shirt size (non-denied ticket).
type UpdateTshirtSizeRequest struct {
	TshirtSize string `json:"tshirt_size" binding:"omitempty,oneof=XS S M L XL XXL 3XL"`
}
...
type UpdateTicketForAdminRequest struct {
	...
	TshirtSize     *string `json:"tshirt_size" binding:"omitempty,max=10"`
